...
\begin{center}
    ...
    \centering \texttt{pydeblur} & Python implementation of motion deblur algorithm. Also includes system analysis tools for convolutional forward models. & \footnotesize{\url{https://github.com/zfphil/pydeblur}}\\
    \hline
