...
\usepackage{biblatex, mathrsfs, graphicx}
\usepackage{amsmath,amssymb,amsfonts,hyperref,lineno,microtype,setspace,multicol,textcomp, marvosym, algorithm,algpseudocode}
...
\chair{Professor Lydia Sohn}
\othermembers{Ted Van Duzer Associate Professor Laura Waller, Assistant Professor Ren Ng}
% \othermembers{}
\numberofmembers{3}
...
\include{chap4_self_calibration}
\include{chap5_fabrication}
